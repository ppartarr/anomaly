...
class RawPacketFeatureExtractor:
    ...
    def __init__(self, file_path, limit=np.inf):
        ...
        self.nstat = NetworkStatistics(np.nan, maxHost, maxSess)
    ...
    def get_next_vector(self):
        ...
        # Extract Features
        try:
            return self.nstat.update_get_stats(IPtype, srcMAC, dstMAC, srcIP, srcproto, dstIP, dstproto,
                                               int(framelen),
                                               float(timestamp))
    ...
    def get_num_features(self):
        print(self.nstat.get_net_stat_headers())
        return len(self.nstat.get_net_stat_headers())
